...
if(isset($_POST['btProximo'])){
    ...
    {
        $_error_ = true;
        $_error_msg_ = 'Preencha seu nome';
    }else{
        $nome = $mysqli->real_escape_string($_POST['value']);
        setcookie('register_nome',$nome, time() + (86400 * 30), "/");
        $_SUCCESS = true; 
    } 
}
    ...
    <?php 
        ...
        if (($_error_ == false) and ($_SUCCESS == true)){
            ...
            echo "<script type='text/javascript'>
                window.parent.location.href = 'user.mobile.email.php?redirect=".$redirect_url."';
            </script>";         
        }         
    ?>     
</body>
