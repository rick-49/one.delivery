...
{    
    ...
    $path_img = "https://app.cataloguei.shop/painel/".$path_img;
    $headers = @get_headers($path_img );
    if ($headers && strpos($headers[0], '200') !== false) 
    {
        // imagem ativa
    } else {
        $path_img = "../assets/img/produto-sem-imagem.png";
    }
...
// função para verificar se esta em abiente mobile
function isMobile() {
    ...
    return preg_match($mobileAgents, $_SERVER['HTTP_USER_AGENT']);
}
    ...
    if(!isset($_COOKIE['authorization_id'])) {
        ...
        if (isMobile()) 
        {
            ...
            echo "<script type='text/javascript'>
                window.parent.location.href = '../register/login.mobile.phone.php?type=user&redirect=". urlencode($link)."';
            </script>";
            
        }else{

            echo "<script type='text/javascript'>
                window.location.href = '../login.php?type=user&redirect=". urlencode($link)."';
            </script>";
...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='../assets/css/main.css?v=1.4.1'>
    <link rel='stylesheet' type='text/css' media='screen' href='../assets/css/buttons.css?v=1.4.1'>
    <link rel='stylesheet' type='text/css' media='screen' href='../assets/css/alerts.css?v=1.4.1'>
    <!--boxicon-->
...
<body>
    ...
    <div class="b-main-p-prodto-display-img b-main-centro-total"><img src="<?php echo($path_img); ?>"/></div>
